class E0_poker extends Phaser.Scene {
 ...
 create() {
   ...
   // this.add.text(GAME_WIDTH/2-100,GAME_HEIGHT-100, leva,{ fontSize: '40px',  fill: '#E950F4',fontFamily: 'CustomFont' });
   ...
   // this.add.text(GAME_WIDTH/2+100,GAME_HEIGHT-100, desna,{ fontSize: '40px',  fill: '#E950F4',fontFamily: 'CustomFont' });
    ...
    if (usa == true){
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 480, 'HIGHER ^',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
    else if (rus == true){
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 480, 'БОЛЬШЕ ^',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
    else{
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 480, 'VEČJA ^',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });}
    this.vecji.setScale(0.8)

    this.manjsi = this.add.sprite(GAME_WIDTH/2+200,GAME_HEIGHT - 300, 'gumb').setInteractive();
    if (usa == true){
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 300, 'LOWER ˇ',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
    else if (rus == true){
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 300, 'МЕНЬШЕ ˇ',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
    else{
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 300, 'MANJŠA ˇ',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });}
    ...
    if(leva == desna){
        this.vecji.on('pointerup', () => {
            ...
            if (usa == true){
                this.add.text(x,y, 'NEXT',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
            else if (rus == true){
                this.add.text(x,y, 'СЛЕДУЮЩИЙ',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
            else{
                this.add.text(x,y, 'NASLEDNJI',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });}
        ...
        this.manjsi.on('pointerup', () => {
            ...
            if (usa == true){
             this.add.text(x,y, 'TO TOWN',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
            else if (rus == true){
                this.add.text(x,y, 'В ГОРОД',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
            else{
                this.add.text(x,y, 'V MESTO',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });}
            if(vrniNaPogoj == true){
