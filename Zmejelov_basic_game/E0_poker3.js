class E0_poker3 extends Phaser.Scene {
 ...
 create() {
    ...
    if (usa == true){
        ...
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 480, 'ВИШЕ ^',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
    else{
    ...
    if (usa == true){
        ...
        this.add.text(GAME_WIDTH/2+150,GAME_HEIGHT - 300, 'НИЖЕ ˇ',{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });   }
    else{
