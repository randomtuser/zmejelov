class A0_vsi_nivoji extends Phaser.Scene {
 ...
 create() {
    ...
    if (usa == true){
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'NEXT',{ fontSize: '40px', fill: '#B637BF' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'HOME',{ fontSize: '40px', fill: '#B637BF' });    }
    else if (rus == true){
        this.add.text(GAME_WIDTH-270,GAME_HEIGHT - 115, 'СЛЕДУЮЩИЙ',{ fontSize: '20px', fill: '#B637BF' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'ДОМОЙ',{ fontSize: '40px', fill: '#B637BF' });    }
    else{
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'NAPREJ',{ fontSize: '40px', fill: '#B637BF' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'DOMOV',{ fontSize: '40px', fill: '#B637BF' });}
