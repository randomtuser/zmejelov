class A0_vsi_nivoji2 extends Phaser.Scene {
 ...
 create() {
    ...
    if (usa == true){
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'BACK',{ fontSize: '40px', fill: '#B637BF' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'HOME',{ fontSize: '40px', fill: '#B637BF' });    }
    else if (rus == true){
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'НАЗАД',{ fontSize: '40px', fill: '#B637BF' });
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 190, 'ДОМОЙ',{ fontSize: '40px', fill: '#B637BF' });    }
    else{
        this.add.text(GAME_WIDTH-265,GAME_HEIGHT - 115, 'NAZAJ',{ fontSize: '40px', fill: '#B637BF' });
