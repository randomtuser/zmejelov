class scena4 extends Phaser.Scene {
	constructor(){
		super({ key: 'scena4' });
	}
	 preload(){
...
this.physics.add.overlap(gameState.junak2, izhod4, () => {
					      this.add.text(150, 50,  'da vstaneš od mrtvih bo pa potrebno malo več truda\n  Klikni na zaslon za naslednji level', { fontFamily: 'Arial', fontSize: 36, color: '#000000' });
