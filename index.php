...
<body>
    ...
    <div  id="introduction_FrontPage" >
      <img src="assets/lvl2/Wraith_03_Idle_006.png" alt="Zmeja" class="zmeja" class="col-10">
      <div class="introductionText" >
      <?php if(isset($_SESSION["username"])):?>
            <p id="introductionText">Še enkrat pozdravljeni na ZMEJELOV IGRALNI PLATFORMI. Moje ime je Zmeja in moram priznati, da sem zelo vesela,
        ...
        <?php else:?>
            <p id="introductionText">Naj poudarim, da sem zelo vesela, da te vidim! Na portalu je 5 iger za veliko ur igranja, z dosežki pa te spodbujam k igranju. Če mene vprašaš moraš preigrati vse xd. Za njihovo uporabo pa se moraš registrirati s klikom <a href="SERVER\register.php">tukaj</a> ali pa prijaviti s klikom <a href="SERVER\login.php">tukaj</a>. Veselo igranje. </p>
            <?php endif; ?>
      </div>
    </div><div> </div>
